...
package net.kuina.nebulaecraft.keybind;
...
import net.kuina.nebulaecraft.procedure.ProcedureModeSwitchingEvent;
...
public class KeyBindingModeSwitching extends ElementsNebulaecraftMod.ModElement {
	private KeyBinding keys;
	public KeyBindingModeSwitching(ElementsNebulaecraftMod instance) {
		super(instance, 147);
	}
	...
	public void init(FMLInitializationEvent event) {
		keys = new KeyBinding("key.mcreator.mode_switching", Keyboard.KEY_R, "key.categories.misc");
	...
	private static void pressAction(EntityPlayer entity) {
			...
			return;
		{
			...
			ProcedureModeSwitchingEvent.executeProcedure($_dependencies);
		}
	}
}
