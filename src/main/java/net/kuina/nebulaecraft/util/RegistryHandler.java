...
public class RegistryHandler extends ElementsNebulaecraftMod.ModElement {
    ...
    public void initElements() {
        ...
        for (int i = 85; i <= 86; i++) registerBlock(new BlockRoadsignSmall.BlockCustom(), "roadsign_" + i);
        registerBlock(new BlockRoadsignSmall.BlockCustom(), "roadsign_88");
        for (int i = 90; i <= 92; i++) registerBlock(new BlockRoadsignSmall.BlockCustom(), "roadsign_" + i);
        for (int i = 94; i <= 96; i++) registerBlock(new BlockRoadsignSmall.BlockCustom(), "roadsign_" + i);
        registerBlock(new BlockRoadsignSmall.BlockCustom(), "roadsign_98");
        ...
        registerBlock(new BlockAsphaltAddon.BlockCustom(), "asphalt_white_line_fork");
        registerBlock(new BlockAsphaltSlabAddon.BlockCustom(), "asphalt_white_line_fork_slab");
        ...
        registerBlock(new BlockAsphaltAddon.BlockCustom(), "asphalt_yellow_line_fork");
        registerBlock(new BlockAsphaltSlabAddon.BlockCustom(), "asphalt_yellow_line_fork_slab");
        ...
        registerBlock(new BlockAsphaltSlabAddon.BlockCustom(), "asphalt_crosswalk_slab");
        ...
        registerBlock(new BlockAsphaltAddon.BlockCustom(), "asphalt_bus_half_wline");
        registerBlock(new BlockAsphaltSlabAddon.BlockCustom(), "asphalt_bus_half_wline_slab");
        registerBlock(new BlockAsphaltAddon.BlockCustom(), "asphalt_bus_half_wline_diagonal_right");
        registerBlock(new BlockAsphaltSlabAddon.BlockCustom(), "asphalt_bus_half_wline_diagonal_right_slab");
        registerBlock(new BlockAsphaltAddon.BlockCustom(), "asphalt_bus_half_wline_diagonal_left");
        registerBlock(new BlockAsphaltSlabAddon.BlockCustom(), "asphalt_bus_half_wline_diagonal_left_slab");
        ...
        registerBlock(new BlockAsphaltAddon.BlockCustom(), "asphalt_parallel_yellow_full");
        registerBlock(new BlockAsphaltSlabAddon.BlockCustom(), "asphalt_parallel_yellow_full_slab");
        registerBlock(new BlockAsphaltAddon.BlockCustom(), "asphalt_parallel_yellow_half");
        registerBlock(new BlockAsphaltSlabAddon.BlockCustom(), "asphalt_parallel_yellow_half_slab");
        registerBlock(new BlockAsphaltAddon.BlockCustom(), "asphalt_parallel_yellow_fork_right");
        registerBlock(new BlockAsphaltSlabAddon.BlockCustom(), "asphalt_parallel_yellow_fork_right_slab");
        registerBlock(new BlockAsphaltAddon.BlockCustom(), "asphalt_parallel_yellow_fork_left");
        registerBlock(new BlockAsphaltSlabAddon.BlockCustom(), "asphalt_parallel_yellow_fork_left_slab");
        registerBlock(new BlockAsphaltAddon.BlockCustom(), "asphalt_parallel_yellow_merge_right");
        registerBlock(new BlockAsphaltSlabAddon.BlockCustom(), "asphalt_parallel_yellow_merge_right_slab");
        registerBlock(new BlockAsphaltAddon.BlockCustom(), "asphalt_parallel_yellow_merge_left");
        registerBlock(new BlockAsphaltSlabAddon.BlockCustom(), "asphalt_parallel_yellow_merge_left_slab");
