...
/** Built-in double-track metro bridge using the metro tunnel 2 trackbed layout. */
public final class MetroBridge2Template implements AutogenTemplate {
    public static final String ID = "bridge_metro_2";
    private static final String DISPLAY_NAME = "地铁桥梁 2";
    ...
    public AutogenPlan build(
        ...
        return MetroBridge2Builder.build(world, selection, ID, DISPLAY_NAME);
    }
}
