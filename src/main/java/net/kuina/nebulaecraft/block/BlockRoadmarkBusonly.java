...
public class BlockRoadmarkBusonly extends ElementsNebulaecraftMod.ModElement {
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("nebulaecraft:roadmark_busonly", "inventory"));
	}
	public static class BlockCustom extends Block {
		...
		public AxisAlignedBB getBoundingBox(IBlockState state, IBlockAccess source, BlockPos pos) {
			switch (state.getValue(BlockHorizontal.FACING)) {
				case SOUTH :
				default :
					return new AxisAlignedBB(0.1875, 0, -1, 0.8125, 0.1, 2);
				case NORTH :
					return new AxisAlignedBB(0.1875, 0, -1, 0.8125, 0.1, 2);
				case EAST :
					return new AxisAlignedBB(-1, 0, 0.1875, 2, 0.1, 0.8125);
				case WEST :
					return new AxisAlignedBB(-1, 0, 0.1875, 2, 0.1, 0.8125);
			}
		}
