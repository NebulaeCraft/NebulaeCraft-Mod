...
public class BlockRoadmarkBusonly extends ElementsNebulaecraftMod.ModElement {
    ...
    public void initElements() {
        elements.blocks.add(() -> new BlockCustom().setRegistryName("roadmark_busonly"));
    ...
    public void registerModels(ModelRegistryEvent event) {
        BlockRoadmarkBusonly.BlockCustom.EnumType[] allSubtypes = BlockRoadmarkBusonly.BlockCustom.EnumType.values();
        for (BlockRoadmarkBusonly.BlockCustom.EnumType subtype : allSubtypes) {
            ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), subtype.getMetadata(), new ModelResourceLocation("nebulaecraft:roadmark_busonly_" + subtype.getName(), "inventory"));
        }
    }
    ...
    public static class BlockCustom extends Block {
        ...
        public BlockCustom() {
			...
			setUnlocalizedName("roadmark_busonly");
        ...
        public enum EnumType implements IStringSerializable {
            ...
            private static final BlockRoadmarkBusonly.BlockCustom.EnumType[] META_LOOKUP = new BlockRoadmarkBusonly.BlockCustom.EnumType[values().length];

            static {
                for (BlockRoadmarkBusonly.BlockCustom.EnumType type : values()) {
            ...
            public static BlockRoadmarkBusonly.BlockCustom.EnumType byMetadata(int meta) {
