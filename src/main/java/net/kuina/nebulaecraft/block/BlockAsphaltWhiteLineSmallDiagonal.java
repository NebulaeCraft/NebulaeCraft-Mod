...
public class BlockAsphaltWhiteLineSmallDiagonal extends ElementsNebulaecraftMod.ModElement {
	@GameRegistry.ObjectHolder("nebulaecraft:asphalt_white_line_small_diagonal")
	public static final Block block = null;
	public BlockAsphaltWhiteLineSmallDiagonal(ElementsNebulaecraftMod instance) {
		super(instance, 11);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("asphalt_white_line_small_diagonal"));
	...
	public void registerModels(ModelRegistryEvent event) {
        BlockAsphaltWhiteLineSmallDiagonal.BlockCustom.EnumType[] allSubtypes = BlockAsphaltWhiteLineSmallDiagonal.BlockCustom.EnumType.values();
        for (BlockAsphaltWhiteLineSmallDiagonal.BlockCustom.EnumType subtype : allSubtypes) {
            ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), subtype.getMetadata(), new ModelResourceLocation("nebulaecraft:asphalt_white_line_small_diagonal_" + subtype.getName(), "inventory"));
        }
    }
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setUnlocalizedName("asphalt_white_line_small_diagonal");
        ...
        public enum EnumType implements IStringSerializable {
            ...
            private static final BlockAsphaltWhiteLineSmallDiagonal.BlockCustom.EnumType[] META_LOOKUP = new BlockAsphaltWhiteLineSmallDiagonal.BlockCustom.EnumType[values().length];

            static {
                for (BlockAsphaltWhiteLineSmallDiagonal.BlockCustom.EnumType type : values()) {
            ...
            public static BlockAsphaltWhiteLineSmallDiagonal.BlockCustom.EnumType byMetadata(int meta) {
