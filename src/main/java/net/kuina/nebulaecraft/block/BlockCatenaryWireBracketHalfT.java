...
public class BlockCatenaryWireBracketHalfT extends ElementsNebulaecraftMod.ModElement {
	...
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("catenary_wire_bracket_half_t"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("nebulaecraft:catenary_wire_bracket_half_t", "inventory"));
	}
	public static class BlockCustom extends Block {
		public static final PropertyDirection FACING = BlockHorizontal.FACING;
		public BlockCustom() {
			super(Material.IRON);
			setUnlocalizedName("catenary_wire_bracket_half_t");
		...
		public AxisAlignedBB getBoundingBox(IBlockState state, IBlockAccess source, BlockPos pos) {
			switch (state.getValue(BlockHorizontal.FACING)) {
				case SOUTH :
				default :
					return new AxisAlignedBB(0, 0, 0.3125, 1, 0.6875, 0.6875);
				case NORTH :
					return new AxisAlignedBB(0, 0, 0.3125, 1, 0.6875, 0.6875);
				case EAST :
					return new AxisAlignedBB(0.3125, 0, 0, 0.6875, 0.6875, 1);
				case WEST :
					return new AxisAlignedBB(0.3125, 0, 0, 0.6875, 0.6875, 1);
			}
		}
