...
public class BlockLabelsign6 extends ElementsNebulaecraftMod.ModElement {
	@GameRegistry.ObjectHolder("nebulaecraft:labelsign_6")
	public static final Block block = null;
	public BlockLabelsign6(ElementsNebulaecraftMod instance) {
		super(instance, 81);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("labelsign_6"));
	...
	public void registerModels(ModelRegistryEvent event) {
        BlockLabelsign6.BlockCustom.EnumType[] allSubtypes = BlockLabelsign6.BlockCustom.EnumType.values();
        for (BlockLabelsign6.BlockCustom.EnumType subtype : allSubtypes) {
            ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), subtype.getMetadata(), new ModelResourceLocation("nebulaecraft:labelsign_6_" + subtype.getName(), "inventory"));
        }
    }
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.IRON);
			setUnlocalizedName("labelsign_6");
		...
		public AxisAlignedBB getBoundingBox(IBlockState state, IBlockAccess source, BlockPos pos) {
            if(state.getValue(SUBTYPE).getMetadata()==0){
                ...
                switch ((EnumFacing) state.getValue(BlockHorizontal.FACING)) {
                    case SOUTH:
                    default:
                        return new AxisAlignedBB(0, 0.43, 0, 1, 1, 0.1);
                    case NORTH:
                        return new AxisAlignedBB(0, 0.43, 0.9, 1, 1, 1);
                    case EAST:
                        return new AxisAlignedBB(0, 0.43, 0, 0.1, 1, 1);
                    case WEST:
                        return new AxisAlignedBB(0.9, 0.43, 0, 1, 1, 1);
                }
            }
		}
        ...
        public static enum EnumType implements IStringSerializable {
            ...
            private static final BlockLabelsign6.BlockCustom.EnumType[] META_LOOKUP = new BlockLabelsign6.BlockCustom.EnumType[values().length];

            static {
                for (BlockLabelsign6.BlockCustom.EnumType type : values()) {
            ...
            public static BlockLabelsign6.BlockCustom.EnumType byMetadata(int meta) {
