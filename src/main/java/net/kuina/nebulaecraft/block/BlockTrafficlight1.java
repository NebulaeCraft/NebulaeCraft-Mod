...
public class BlockTrafficlight1 extends ElementsNebulaecraftMod.ModElement {
    @GameRegistry.ObjectHolder("nebulaecraft:trafficlight_1")
    public static final Block block = null;

    public BlockTrafficlight1(ElementsNebulaecraftMod instance) {
        super(instance, 32);
    }

    @Override
    public void initElements() {
        elements.blocks.add(() -> new BlockCustom().setRegistryName("trafficlight_1"));
    ...
    public void registerModels(ModelRegistryEvent event) {
        BlockTrafficlight1.BlockCustom.EnumType[] allSubtypes = BlockTrafficlight1.BlockCustom.EnumType.values();
        for (BlockTrafficlight1.BlockCustom.EnumType subtype : allSubtypes) {
            ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), subtype.getMetadata(), new ModelResourceLocation("nebulaecraft:trafficlight_1_" + subtype.getName(), "inventory"));
        }
    }
    ...
    public static class BlockCustom extends Block {
        ...
        public BlockCustom() {
            super(Material.IRON);
            setUnlocalizedName("trafficlight_1");
        ...
        public enum EnumType implements IStringSerializable {
            ...
            private static final BlockTrafficlight1.BlockCustom.EnumType[] META_LOOKUP = new BlockTrafficlight1.BlockCustom.EnumType[values().length];

            static {
                for (BlockTrafficlight1.BlockCustom.EnumType type : values()) {
            ...
            public static BlockTrafficlight1.BlockCustom.EnumType byMetadata(int meta) {
