...
public class BlockTrafficlightPole extends ElementsNebulaecraftMod.ModElement {
    @GameRegistry.ObjectHolder("nebulaecraft:trafficlight_pole")
    ...
    public void initElements() {
        elements.blocks.add(() -> new BlockCustom().setRegistryName("trafficlight_pole"));
    ...
    public void registerModels(ModelRegistryEvent event) {
        BlockTrafficlightPole.BlockCustom.EnumType[] allSubtypes = BlockTrafficlightPole.BlockCustom.EnumType.values();
        for (BlockTrafficlightPole.BlockCustom.EnumType subtype : allSubtypes) {
            ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), subtype.getMetadata(), new ModelResourceLocation("nebulaecraft:trafficlight_pole_" + subtype.getName(), "inventory"));
        }
    }
    ...
    public static class BlockCustom extends Block {
        ...
        public BlockCustom() {
            super(Material.IRON);
            setUnlocalizedName("trafficlight_pole");
        ...
        public enum EnumType implements IStringSerializable {
            ...
            private static final BlockTrafficlightPole.BlockCustom.EnumType[] META_LOOKUP = new BlockTrafficlightPole.BlockCustom.EnumType[values().length];

            static {
                for (BlockTrafficlightPole.BlockCustom.EnumType type : values()) {
            ...
            public static BlockTrafficlightPole.BlockCustom.EnumType byMetadata(int meta) {
