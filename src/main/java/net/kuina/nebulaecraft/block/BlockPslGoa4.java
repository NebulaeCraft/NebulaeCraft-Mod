...
public class BlockPslGoa4 extends ElementsNebulaecraftMod.ModElement {
    @GameRegistry.ObjectHolder("nebulaecraft:psl_goa4")
    public static final Block block = null;

    public BlockPslGoa4(ElementsNebulaecraftMod instance) {
        super(instance, 106);
    }

    @Override
    public void initElements() {
        elements.blocks.add(() -> new BlockCustom().setRegistryName("psl_goa4"));
    ...
    public void registerModels(ModelRegistryEvent event) {
        BlockPslGoa4.BlockCustom.EnumType[] allSubtypes = BlockPslGoa4.BlockCustom.EnumType.values();
        for (BlockPslGoa4.BlockCustom.EnumType subtype : allSubtypes) {
            ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), subtype.getMetadata(), new ModelResourceLocation("nebulaecraft:psl_goa4_" + subtype.getName(), "inventory"));
        }
    }
    ...
    public static class BlockCustom extends Block {
        ...
        public enum EnumType implements IStringSerializable {
            ...
            private static final BlockPslGoa4.BlockCustom.EnumType[] META_LOOKUP = new BlockPslGoa4.BlockCustom.EnumType[values().length];

            static {
                for (BlockPslGoa4.BlockCustom.EnumType type : values()) {
            ...
            public static BlockPslGoa4.BlockCustom.EnumType byMetadata(int meta) {
