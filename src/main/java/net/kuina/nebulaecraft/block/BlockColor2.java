...
public class BlockColor2 extends ElementsNebulaecraftMod.ModElement {
	@GameRegistry.ObjectHolder("nebulaecraft:color_2")
	public static final Block block = null;
	
	public BlockColor2(ElementsNebulaecraftMod instance) {
		super(instance, 2);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("color_2"));
	...
	public void registerModels(ModelRegistryEvent event) {
        BlockColor2.BlockCustom.EnumType[] allSubtypes = BlockColor2.BlockCustom.EnumType.values();
        for (BlockColor2.BlockCustom.EnumType subtype : allSubtypes) {
            ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), subtype.getMetadata(), new ModelResourceLocation("nebulaecraft:color_2_" + subtype.getName(), "inventory"));
        }
    }
	...
	public static class BlockCustom extends Block {
        ...
        public enum EnumType implements IStringSerializable {
            ...
            private static final BlockColor2.BlockCustom.EnumType[] META_LOOKUP = new BlockColor2.BlockCustom.EnumType[values().length];

            static {
                for (BlockColor2.BlockCustom.EnumType type : values()) {
            ...
            public static BlockColor2.BlockCustom.EnumType byMetadata(int meta) {
