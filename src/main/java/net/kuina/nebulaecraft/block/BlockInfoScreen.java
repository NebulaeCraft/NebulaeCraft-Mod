...
public class BlockInfoScreen extends ElementsNebulaecraftMod.ModElement {

	public BlockInfoScreen(ElementsNebulaecraftMod instance) {
		super(instance, 73);
	}
	...
	public static final class BlockCustom extends Block {
		...
		public AxisAlignedBB getBoundingBox(IBlockState state, IBlockAccess source, BlockPos pos) {  //TODO Input AABB data SMALL
			switch (state.getValue(BlockHorizontal.FACING)) {
				case SOUTH :
				default :
					return new AxisAlignedBB(0, 0.4375, 0.25, 1, 1, 0.75);
				case NORTH :
					return new AxisAlignedBB(0, 0.4375, 0.25, 1, 1, 0.75);
				case EAST :
					return new AxisAlignedBB(0.25, 0.4375, 0, 0.75, 1, 1);
				case WEST :
					return new AxisAlignedBB(0.25, 0.4375, 0, 0.75, 1, 1);
			}
		}
