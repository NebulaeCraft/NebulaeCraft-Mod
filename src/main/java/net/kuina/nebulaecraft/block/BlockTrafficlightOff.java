...
public class BlockTrafficlightOff extends ElementsNebulaecraftMod.ModElement {
    @GameRegistry.ObjectHolder("nebulaecraft:trafficlight_off")
    public static final Block block = null;

    public BlockTrafficlightOff(ElementsNebulaecraftMod instance) {
        super(instance, 34);
    }

    @Override
    public void initElements() {
        elements.blocks.add(() -> new BlockCustom().setRegistryName("trafficlight_off"));
    ...
    public void registerModels(ModelRegistryEvent event) {
        BlockTrafficlightOff.BlockCustom.EnumType[] allSubtypes = BlockTrafficlightOff.BlockCustom.EnumType.values();
        for (BlockTrafficlightOff.BlockCustom.EnumType subtype : allSubtypes) {
            ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), subtype.getMetadata(), new ModelResourceLocation("nebulaecraft:trafficlight_off_" + subtype.getName(), "inventory"));
        }
    }
    ...
    public static class BlockCustom extends Block {
        ...
        public BlockCustom() {
            super(Material.IRON);
            setUnlocalizedName("trafficlight_off");
		...
		public AxisAlignedBB getBoundingBox(IBlockState state, IBlockAccess source, BlockPos pos) {
            if (state.getValue(SUBTYPE).getMetadata() == 0) {
				...
				case NORTH :
					return new AxisAlignedBB(0.3125, 0, 0.75, 0.6875, 1, 1);
				case EAST :
        ...
        public enum EnumType implements IStringSerializable {
            ...
            private static final BlockTrafficlightOff.BlockCustom.EnumType[] META_LOOKUP = new BlockTrafficlightOff.BlockCustom.EnumType[values().length];

            static {
                for (BlockTrafficlightOff.BlockCustom.EnumType type : values()) {
            ...
            public static BlockTrafficlightOff.BlockCustom.EnumType byMetadata(int meta) {
