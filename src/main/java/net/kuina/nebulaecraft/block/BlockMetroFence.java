...
public class BlockMetroFence extends ElementsNebulaecraftMod.ModElement {
	@GameRegistry.ObjectHolder("nebulaecraft:metro_fence")
	public static final Block block = null;
	public BlockMetroFence(ElementsNebulaecraftMod instance) {
		super(instance, 88);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("metro_fence"));
