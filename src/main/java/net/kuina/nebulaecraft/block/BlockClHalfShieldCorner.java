...
public class BlockClHalfShieldCorner extends ElementsNebulaecraftMod.ModElement {
    @GameRegistry.ObjectHolder("nebulaecraft:cl_half_shield_corner")
    public static final Block block = null;

    public BlockClHalfShieldCorner(ElementsNebulaecraftMod instance) {
        super(instance, 113);
    }

    @Override
    public void initElements() {
        elements.blocks.add(() -> new BlockCustom().setRegistryName("cl_half_shield_corner"));
    ...
    public void registerModels(ModelRegistryEvent event) {
        BlockClHalfShieldCorner.BlockCustom.EnumType[] allSubtypes = BlockClHalfShieldCorner.BlockCustom.EnumType.values();
        for (BlockClHalfShieldCorner.BlockCustom.EnumType subtype : allSubtypes) {
            ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), subtype.getMetadata(), new ModelResourceLocation("nebulaecraft:cl_half_shield_corner_" + subtype.getName(), "inventory"));
        }
    }
    ...
    public static class BlockCustom extends Block {
        ...
        public BlockCustom() {
			...
			setUnlocalizedName("cl_half_shield_corner");
			setHardness(1F);
			setResistance(10F);
			setLightLevel(0F);
			setLightOpacity(0);
        ...
        public enum EnumType implements IStringSerializable {
            ...
            private static final BlockClHalfShieldCorner.BlockCustom.EnumType[] META_LOOKUP = new BlockClHalfShieldCorner.BlockCustom.EnumType[values().length];

            static {
                for (BlockClHalfShieldCorner.BlockCustom.EnumType type : values()) {
            ...
            public static BlockClHalfShieldCorner.BlockCustom.EnumType byMetadata(int meta) {
