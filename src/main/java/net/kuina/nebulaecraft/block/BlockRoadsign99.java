...
public class BlockRoadsign99 extends ElementsNebulaecraftMod.ModElement {
    @GameRegistry.ObjectHolder("nebulaecraft:roadsign_99")
    public static final Block block = null;

    public BlockRoadsign99(ElementsNebulaecraftMod instance) {
        super(instance, 35);
    }

    @Override
    public void initElements() {
        elements.blocks.add(() -> new BlockCustom().setRegistryName("roadsign_99"));
    ...
    public void registerModels(ModelRegistryEvent event) {
        BlockRoadsign99.BlockCustom.EnumType[] allSubtypes = BlockRoadsign99.BlockCustom.EnumType.values();
        for (BlockRoadsign99.BlockCustom.EnumType subtype : allSubtypes) {
            ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), subtype.getMetadata(), new ModelResourceLocation("nebulaecraft:roadsign_99_" + subtype.getName(), "inventory"));
        }
    }
    ...
    public static class BlockCustom extends Block {
        ...
        public BlockCustom() {
			...
			setUnlocalizedName("roadsign_99");
			setHardness(1F);
			setResistance(10F);
			setLightLevel(0F);
			setLightOpacity(0);
        ...
        public enum EnumType implements IStringSerializable {
            ...
            private static final BlockRoadsign99.BlockCustom.EnumType[] META_LOOKUP = new BlockRoadsign99.BlockCustom.EnumType[values().length];

            static {
                for (BlockRoadsign99.BlockCustom.EnumType type : values()) {
            ...
            public static BlockRoadsign99.BlockCustom.EnumType byMetadata(int meta) {
