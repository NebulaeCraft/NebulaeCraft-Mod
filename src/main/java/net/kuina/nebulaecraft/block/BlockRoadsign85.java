...
public class BlockRoadsign85 extends ElementsNebulaecraftMod.ModElement {
	...
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("roadsign_85"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("nebulaecraft:roadsign_85", "inventory"));
	}
	public static final class BlockCustom extends Block {
		...
		public BlockCustom() {
			...
			setUnlocalizedName("roadsign_85");
			setHardness(1F);
			setResistance(10F);
			setLightLevel(0F);
			setLightOpacity(0);
