...
public class BlockSignpoleThin extends ElementsNebulaecraftMod.ModElement {
	@GameRegistry.ObjectHolder("nebulaecraft:signpole_thin")
	public static final Block block = null;
	
	public BlockSignpoleThin(ElementsNebulaecraftMod instance) {
		super(instance, 36);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("signpole_thin"));
	...
	public void registerModels(ModelRegistryEvent event) {
        BlockSignpoleThin.BlockCustom.EnumType[] allSubtypes = BlockSignpoleThin.BlockCustom.EnumType.values();
        for (BlockSignpoleThin.BlockCustom.EnumType subtype : allSubtypes) {
            ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), subtype.getMetadata(), new ModelResourceLocation("nebulaecraft:signpole_thin_" + subtype.getName(), "inventory"));
        }
    }
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.IRON);
			setUnlocalizedName("signpole_thin");
        ...
        public enum EnumType implements IStringSerializable {
            ...
            private static final BlockSignpoleThin.BlockCustom.EnumType[] META_LOOKUP = new BlockSignpoleThin.BlockCustom.EnumType[values().length];

            static {
                for (BlockSignpoleThin.BlockCustom.EnumType type : values()) {
            ...
            public static BlockSignpoleThin.BlockCustom.EnumType byMetadata(int meta) {
