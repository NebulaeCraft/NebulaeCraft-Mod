...
public class BlockClHalfShieldEnddoor extends ElementsNebulaecraftMod.ModElement {
    @GameRegistry.ObjectHolder("nebulaecraft:cl_half_shield_enddoor")
    public static final Block block = null;

    public BlockClHalfShieldEnddoor(ElementsNebulaecraftMod instance) {
        super(instance, 113);
    }

    @Override
    public void initElements() {
        elements.blocks.add(() -> new BlockCustom().setRegistryName("cl_half_shield_enddoor"));
    ...
    public void registerModels(ModelRegistryEvent event) {
        BlockClHalfShieldEnddoor.BlockCustom.EnumType[] allSubtypes = BlockClHalfShieldEnddoor.BlockCustom.EnumType.values();
        for (BlockClHalfShieldEnddoor.BlockCustom.EnumType subtype : allSubtypes) {
            ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), subtype.getMetadata(), new ModelResourceLocation("nebulaecraft:cl_half_shield_enddoor_" + subtype.getName(), "inventory"));
        }
    }
    ...
    public static class BlockCustom extends Block {
        ...
        public BlockCustom() {
			...
			setUnlocalizedName("cl_half_shield_enddoor");
			setHardness(1F);
			setResistance(10F);
			setLightLevel(0F);
			setLightOpacity(0);
        ...
        public enum EnumType implements IStringSerializable {
            ...
            private static final BlockClHalfShieldEnddoor.BlockCustom.EnumType[] META_LOOKUP = new BlockClHalfShieldEnddoor.BlockCustom.EnumType[values().length];

            static {
                for (BlockClHalfShieldEnddoor.BlockCustom.EnumType type : values()) {
            ...
            public static BlockClHalfShieldEnddoor.BlockCustom.EnumType byMetadata(int meta) {
