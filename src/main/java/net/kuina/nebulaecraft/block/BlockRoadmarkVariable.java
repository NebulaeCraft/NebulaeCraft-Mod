...
public class BlockRoadmarkVariable extends ElementsNebulaecraftMod.ModElement {
    @GameRegistry.ObjectHolder("nebulaecraft:roadmark_variable")
    public static final Block block = null;

    public BlockRoadmarkVariable(ElementsNebulaecraftMod instance) {
        super(instance, 40);
    }

    @Override
    public void initElements() {
        elements.blocks.add(() -> new BlockCustom().setRegistryName("roadmark_variable"));
    ...
    public void registerModels(ModelRegistryEvent event) {
        BlockRoadmarkVariable.BlockCustom.EnumType[] allSubtypes = BlockRoadmarkVariable.BlockCustom.EnumType.values();
        for (BlockRoadmarkVariable.BlockCustom.EnumType subtype : allSubtypes) {
            ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), subtype.getMetadata(), new ModelResourceLocation("nebulaecraft:roadmark_variable_" + subtype.getName(), "inventory"));
        }
    }
    ...
    public static class BlockCustom extends Block {
        ...
        public BlockCustom() {
            super(Material.IRON);
            setUnlocalizedName("roadmark_variable");
...
//            System.out.println(EnumFacing.getFront(facing.getIndex() - 2).getName2());
        ...
        public enum EnumType implements IStringSerializable {
            ...
            private static final BlockRoadmarkVariable.BlockCustom.EnumType[] META_LOOKUP = new BlockRoadmarkVariable.BlockCustom.EnumType[values().length];

            static {
                for (BlockRoadmarkVariable.BlockCustom.EnumType type : values()) {
            ...
            public static BlockRoadmarkVariable.BlockCustom.EnumType byMetadata(int meta) {
