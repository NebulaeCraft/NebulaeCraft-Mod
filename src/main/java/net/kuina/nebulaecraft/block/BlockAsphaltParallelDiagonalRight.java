...
public class BlockAsphaltParallelDiagonalRight extends ElementsNebulaecraftMod.ModElement {
	...
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("asphalt_parallel_diagonal_right"));
	...
	public void registerModels(ModelRegistryEvent event) {
        BlockAsphaltParallelDiagonalRight.BlockCustom.EnumType[] allSubtypes = BlockAsphaltParallelDiagonalRight.BlockCustom.EnumType.values();
        for (BlockAsphaltParallelDiagonalRight.BlockCustom.EnumType subtype : allSubtypes) {
            ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), subtype.getMetadata(), new ModelResourceLocation("nebulaecraft:asphalt_parallel_diagonal_right_" + subtype.getName(), "inventory"));
        }
    }
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setUnlocalizedName("asphalt_parallel_diagonal_right");
        ...
        public enum EnumType implements IStringSerializable {
            ...
            private static final BlockAsphaltParallelDiagonalRight.BlockCustom.EnumType[] META_LOOKUP = new BlockAsphaltParallelDiagonalRight.BlockCustom.EnumType[values().length];

            static {
                for (BlockAsphaltParallelDiagonalRight.BlockCustom.EnumType type : values()) {
            ...
            public static BlockAsphaltParallelDiagonalRight.BlockCustom.EnumType byMetadata(int meta) {
