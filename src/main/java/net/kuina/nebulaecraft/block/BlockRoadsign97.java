...
public class BlockRoadsign97 extends ElementsNebulaecraftMod.ModElement {
    @GameRegistry.ObjectHolder("nebulaecraft:roadsign_97")
    public static final Block block = null;

    public BlockRoadsign97(ElementsNebulaecraftMod instance) {
        super(instance, 39);
    }

    @Override
    public void initElements() {
        elements.blocks.add(() -> new BlockCustom().setRegistryName("roadsign_97"));
    ...
    public void registerModels(ModelRegistryEvent event) {
        BlockRoadsign97.BlockCustom.EnumType[] allSubtypes = BlockRoadsign97.BlockCustom.EnumType.values();
        for (BlockRoadsign97.BlockCustom.EnumType subtype : allSubtypes) {
            ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), subtype.getMetadata(), new ModelResourceLocation("nebulaecraft:roadsign_97_" + subtype.getName(), "inventory"));
        }
    }
    ...
    public static class BlockCustom extends Block {
        ...
        public BlockCustom() {
			...
			setUnlocalizedName("roadsign_97");
			setHardness(1F);
			setResistance(10F);
			setLightLevel(0F);
			setLightOpacity(0);
        ...
        public enum EnumType implements IStringSerializable {
            ...
            private static final BlockRoadsign97.BlockCustom.EnumType[] META_LOOKUP = new BlockRoadsign97.BlockCustom.EnumType[values().length];

            static {
                for (BlockRoadsign97.BlockCustom.EnumType type : values()) {
            ...
            public static BlockRoadsign97.BlockCustom.EnumType byMetadata(int meta) {
