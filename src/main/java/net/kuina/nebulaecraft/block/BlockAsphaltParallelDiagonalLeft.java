...
public class BlockAsphaltParallelDiagonalLeft extends ElementsNebulaecraftMod.ModElement {
	@GameRegistry.ObjectHolder("nebulaecraft:asphalt_parallel_diagonal_left")
	public static final Block block = null;
	public BlockAsphaltParallelDiagonalLeft(ElementsNebulaecraftMod instance) {
		super(instance, 4);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("asphalt_parallel_diagonal_left"));
	...
	public void registerModels(ModelRegistryEvent event) {
        BlockAsphaltParallelDiagonalLeft.BlockCustom.EnumType[] allSubtypes = BlockAsphaltParallelDiagonalLeft.BlockCustom.EnumType.values();
        for (BlockAsphaltParallelDiagonalLeft.BlockCustom.EnumType subtype : allSubtypes) {
            ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), subtype.getMetadata(), new ModelResourceLocation("nebulaecraft:asphalt_parallel_diagonal_left_" + subtype.getName(), "inventory"));
        }
    }
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setUnlocalizedName("asphalt_parallel_diagonal_left");
        ...
        public enum EnumType implements IStringSerializable {
            ...
            private static final BlockAsphaltParallelDiagonalLeft.BlockCustom.EnumType[] META_LOOKUP = new BlockAsphaltParallelDiagonalLeft.BlockCustom.EnumType[values().length];

            static {
                for (BlockAsphaltParallelDiagonalLeft.BlockCustom.EnumType type : values()) {
            ...
            public static BlockAsphaltParallelDiagonalLeft.BlockCustom.EnumType byMetadata(int meta) {
