...
public class BlockAsphaltLightGreen extends ElementsNebulaecraftMod.ModElement {
	...
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("asphalt_light_green"));
	...
	public void registerModels(ModelRegistryEvent event) {
        BlockAsphaltLightGreen.BlockCustom.EnumType[] allSubtypes = BlockAsphaltLightGreen.BlockCustom.EnumType.values();
        for (BlockAsphaltLightGreen.BlockCustom.EnumType subtype : allSubtypes) {
            ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), subtype.getMetadata(), new ModelResourceLocation("nebulaecraft:asphalt_light_green_" + subtype.getName(), "inventory"));
        }
    }
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setUnlocalizedName("asphalt_light_green");
        ...
        public enum EnumType implements IStringSerializable {
            ...
            private static final BlockAsphaltLightGreen.BlockCustom.EnumType[] META_LOOKUP = new BlockAsphaltLightGreen.BlockCustom.EnumType[values().length];

            static {
                for (BlockAsphaltLightGreen.BlockCustom.EnumType type : values()) {
            ...
            public static BlockAsphaltLightGreen.BlockCustom.EnumType byMetadata(int meta) {
