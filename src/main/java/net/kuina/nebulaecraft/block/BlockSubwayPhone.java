...
public class BlockSubwayPhone extends ElementsNebulaecraftMod.ModElement {
    @GameRegistry.ObjectHolder("nebulaecraft:subway_phone")
    public static final Block block = null;

    public BlockSubwayPhone(ElementsNebulaecraftMod instance) {
        super(instance, 32);
    }

    @Override
    public void initElements() {
        elements.blocks.add(() -> new BlockSubwayPhone.BlockCustom().setRegistryName("subway_phone"));
    ...
    public void registerModels(ModelRegistryEvent event) {
        BlockSubwayPhone.BlockCustom.EnumType[] allSubtypes = BlockSubwayPhone.BlockCustom.EnumType.values();
        for (BlockSubwayPhone.BlockCustom.EnumType subtype : allSubtypes) {
            ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), subtype.getMetadata(), new ModelResourceLocation("nebulaecraft:subway_phone_" + subtype.getName(), "inventory"));
        }
    }
    ...
    public static class BlockCustom extends Block {
        ...
        public BlockCustom() {
            super(Material.ROCK);
            setUnlocalizedName("subway_phone");
        ...
        public enum EnumType implements IStringSerializable {
            ...
            private static final BlockSubwayPhone.BlockCustom.EnumType[] META_LOOKUP = new BlockSubwayPhone.BlockCustom.EnumType[values().length];

            static {
                for (BlockSubwayPhone.BlockCustom.EnumType type : values()) {
            ...
            public static BlockSubwayPhone.BlockCustom.EnumType byMetadata(int meta) {
