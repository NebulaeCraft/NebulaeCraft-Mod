...
public class BlockClShieldEnddoor extends ElementsNebulaecraftMod.ModElement {
    @GameRegistry.ObjectHolder("nebulaecraft:cl_shield_enddoor")
    public static final Block block = null;

    public BlockClShieldEnddoor(ElementsNebulaecraftMod instance) {
        super(instance, 113);
    }

    @Override
    public void initElements() {
        elements.blocks.add(() -> new BlockCustom().setRegistryName("cl_shield_enddoor"));
    ...
    public void registerModels(ModelRegistryEvent event) {
        BlockClShieldEnddoor.BlockCustom.EnumType[] allSubtypes = BlockClShieldEnddoor.BlockCustom.EnumType.values();
        for (BlockClShieldEnddoor.BlockCustom.EnumType subtype : allSubtypes) {
            ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), subtype.getMetadata(), new ModelResourceLocation("nebulaecraft:cl_shield_enddoor_" + subtype.getName(), "inventory"));
        }
    }
    ...
    public static class BlockCustom extends Block {
        ...
        public BlockCustom() {
			...
			setUnlocalizedName("cl_shield_enddoor");
			setHardness(1F);
			setResistance(10F);
			setLightLevel(0F);
			setLightOpacity(0);
        ...
        public enum EnumType implements IStringSerializable {
            ...
            private static final BlockClShieldEnddoor.BlockCustom.EnumType[] META_LOOKUP = new BlockClShieldEnddoor.BlockCustom.EnumType[values().length];

            static {
                for (BlockClShieldEnddoor.BlockCustom.EnumType type : values()) {
            ...
            public static BlockClShieldEnddoor.BlockCustom.EnumType byMetadata(int meta) {
