...
public class BlockTrackbedElevated extends ElementsNebulaecraftMod.ModElement {
    @GameRegistry.ObjectHolder("nebulaecraft:trackbed_elevated")
    public static final Block block = null;

    public BlockTrackbedElevated(ElementsNebulaecraftMod instance) {
        super(instance, 109);
    }

    @Override
    public void initElements() {
        elements.blocks.add(() -> new BlockCustom().setRegistryName("trackbed_elevated"));
    ...
    public void registerModels(ModelRegistryEvent event) {
        BlockTrackbedElevated.BlockCustom.EnumType[] allSubtypes = BlockTrackbedElevated.BlockCustom.EnumType.values();
        for (BlockTrackbedElevated.BlockCustom.EnumType subtype : allSubtypes) {
            ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), subtype.getMetadata(), new ModelResourceLocation("nebulaecraft:trackbed_elevated_" + subtype.getName(), "inventory"));
        }
    }
    ...
    public static class BlockCustom extends Block {
        ...
        public BlockCustom() {
            super(Material.IRON);
            setUnlocalizedName("trackbed_elevated");
        ...
        public enum EnumType implements IStringSerializable {
            ...
            private static final BlockTrackbedElevated.BlockCustom.EnumType[] META_LOOKUP = new BlockTrackbedElevated.BlockCustom.EnumType[values().length];

            static {
                for (BlockTrackbedElevated.BlockCustom.EnumType type : values()) {
            ...
            public static BlockTrackbedElevated.BlockCustom.EnumType byMetadata(int meta) {
