...
public class BlockAsphaltStopLineEdge extends ElementsNebulaecraftMod.ModElement {
	...
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("asphalt_stop_line_edge"));
	...
	public void registerModels(ModelRegistryEvent event) {
        BlockAsphaltStopLineEdge.BlockCustom.EnumType[] allSubtypes = BlockAsphaltStopLineEdge.BlockCustom.EnumType.values();
        for (BlockAsphaltStopLineEdge.BlockCustom.EnumType subtype : allSubtypes) {
            ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), subtype.getMetadata(), new ModelResourceLocation("nebulaecraft:asphalt_stop_line_edge_" + subtype.getName(), "inventory"));
        }
    }
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setUnlocalizedName("asphalt_stop_line_edge");
        ...
        public enum EnumType implements IStringSerializable {
            ...
            private static final BlockAsphaltStopLineEdge.BlockCustom.EnumType[] META_LOOKUP = new BlockAsphaltStopLineEdge.BlockCustom.EnumType[values().length];

            static {
                for (BlockAsphaltStopLineEdge.BlockCustom.EnumType type : values()) {
            ...
            public static BlockAsphaltStopLineEdge.BlockCustom.EnumType byMetadata(int meta) {
