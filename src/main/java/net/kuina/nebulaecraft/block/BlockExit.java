...
public class BlockExit extends ElementsNebulaecraftMod.ModElement {
    @GameRegistry.ObjectHolder("nebulaecraft:exit")
    public static final Block block = null;

    public BlockExit(ElementsNebulaecraftMod instance) {
        super(instance, 111);
    }

    @Override
    public void initElements() {
        elements.blocks.add(() -> new BlockCustom().setRegistryName("exit"));
    ...
    public void registerModels(ModelRegistryEvent event) {
        BlockExit.BlockCustom.EnumType[] allSubtypes = BlockExit.BlockCustom.EnumType.values();
        for (BlockExit.BlockCustom.EnumType subtype : allSubtypes) {
            ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), subtype.getMetadata(), new ModelResourceLocation("nebulaecraft:exit_" + subtype.getName(), "inventory"));
        }
    }
    ...
    public static class BlockCustom extends Block {
		...
		public AxisAlignedBB getBoundingBox(IBlockState state, IBlockAccess source, BlockPos pos) {
            switch (state.getValue(BlockHorizontal.FACING)) {
                case SOUTH:
                default:
                    return new AxisAlignedBB(0.125, 0.359375, 0, 0.875, 0.640625, 0.0625);
                case NORTH:
                    return new AxisAlignedBB(0.125, 0.359375, 0.9375, 0.875, 0.640625, 1);
                case EAST:
                    return new AxisAlignedBB(0, 0.359375, 0.125, 0.0625, 0.640625, 0.875);
                case WEST:
                    return new AxisAlignedBB(0.9375, 0.359375, 0.125, 1, 0.640625, 0.875);
            }
		}
        ...
        public enum EnumType implements IStringSerializable {
            ...
            private static final BlockExit.BlockCustom.EnumType[] META_LOOKUP = new BlockExit.BlockCustom.EnumType[values().length];

            static {
                for (BlockExit.BlockCustom.EnumType type : values()) {
            ...
            public static BlockExit.BlockCustom.EnumType byMetadata(int meta) {
