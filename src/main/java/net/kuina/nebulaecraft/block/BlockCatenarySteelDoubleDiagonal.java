...
public class BlockCatenarySteelDoubleDiagonal extends ElementsNebulaecraftMod.ModElement {
	@GameRegistry.ObjectHolder("nebulaecraft:catenary_steel_double_diagonal")
	public static final Block block = null;
	public BlockCatenarySteelDoubleDiagonal(ElementsNebulaecraftMod instance) {
		super(instance, 18);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("catenary_steel_double_diagonal"));
	...
	public void registerModels(ModelRegistryEvent event) {
        BlockCatenarySteelDoubleDiagonal.BlockCustom.EnumType[] allSubtypes = BlockCatenarySteelDoubleDiagonal.BlockCustom.EnumType.values();
        for (BlockCatenarySteelDoubleDiagonal.BlockCustom.EnumType subtype : allSubtypes) {
            ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), subtype.getMetadata(), new ModelResourceLocation("nebulaecraft:catenary_steel_double_diagonal_" + subtype.getName(), "inventory"));
        }
    }
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.IRON);
			setUnlocalizedName("catenary_steel_double_diagonal");
        ...
        public enum EnumType implements IStringSerializable {
            ...
            private static final BlockCatenarySteelDoubleDiagonal.BlockCustom.EnumType[] META_LOOKUP = new BlockCatenarySteelDoubleDiagonal.BlockCustom.EnumType[values().length];

            static {
                for (BlockCatenarySteelDoubleDiagonal.BlockCustom.EnumType type : values()) {
            ...
            public static BlockCatenarySteelDoubleDiagonal.BlockCustom.EnumType byMetadata(int meta) {
