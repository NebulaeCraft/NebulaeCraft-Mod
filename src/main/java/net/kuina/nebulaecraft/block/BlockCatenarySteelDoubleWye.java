...
public class BlockCatenarySteelDoubleWye extends ElementsNebulaecraftMod.ModElement {
	@GameRegistry.ObjectHolder("nebulaecraft:catenary_steel_double_wye")
	public static final Block block = null;
	public BlockCatenarySteelDoubleWye(ElementsNebulaecraftMod instance) {
		super(instance, 19);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("catenary_steel_double_wye"));
	...
	public void registerModels(ModelRegistryEvent event) {
        BlockCatenarySteelDoubleWye.BlockCustom.EnumType[] allSubtypes = BlockCatenarySteelDoubleWye.BlockCustom.EnumType.values();
        for (BlockCatenarySteelDoubleWye.BlockCustom.EnumType subtype : allSubtypes) {
            ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), subtype.getMetadata(), new ModelResourceLocation("nebulaecraft:catenary_steel_double_wye_" + subtype.getName(), "inventory"));
        }
    }
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.IRON);
			setUnlocalizedName("catenary_steel_double_wye");
		...
		public AxisAlignedBB getBoundingBox(IBlockState state, IBlockAccess source, BlockPos pos) {
			switch (state.getValue(BlockHorizontal.FACING)) {
				case SOUTH :
				default :
					return new AxisAlignedBB(0, 0, 1, 1, 0.2, 0.4375);
				case NORTH :
        ...
        public enum EnumType implements IStringSerializable {
            ...
            private static final BlockCatenarySteelDoubleWye.BlockCustom.EnumType[] META_LOOKUP = new BlockCatenarySteelDoubleWye.BlockCustom.EnumType[values().length];

            static {
                for (BlockCatenarySteelDoubleWye.BlockCustom.EnumType type : values()) {
            ...
            public static BlockCatenarySteelDoubleWye.BlockCustom.EnumType byMetadata(int meta) {
