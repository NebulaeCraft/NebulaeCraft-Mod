...
public class BlockScreenDoorLidar extends ElementsNebulaecraftMod.ModElement {
	@GameRegistry.ObjectHolder("nebulaecraft:screen_door_lidar")
	public static final Block block = null;
	public BlockScreenDoorLidar(ElementsNebulaecraftMod instance) {
		super(instance, 49);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
        BlockScreenDoorLidar.BlockCustom.EnumType[] allSubtypes = BlockScreenDoorLidar.BlockCustom.EnumType.values();
        for (BlockScreenDoorLidar.BlockCustom.EnumType subtype : allSubtypes) {
            ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), subtype.getMetadata(), new ModelResourceLocation("nebulaecraft:screen_door_lidar_" + subtype.getName(), "inventory"));
        }
    }
	...
	public static class BlockCustom extends Block {
        ...
        public static enum EnumType implements IStringSerializable {
            ...
            private static final BlockScreenDoorLidar.BlockCustom.EnumType[] META_LOOKUP = new BlockScreenDoorLidar.BlockCustom.EnumType[values().length];

            static {
                for (BlockScreenDoorLidar.BlockCustom.EnumType type : values()) {
            ...
            public static BlockScreenDoorLidar.BlockCustom.EnumType byMetadata(int meta) {
