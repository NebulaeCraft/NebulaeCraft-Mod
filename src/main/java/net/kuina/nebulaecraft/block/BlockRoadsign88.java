...
public class BlockRoadsign88 extends ElementsNebulaecraftMod.ModElement {
	@GameRegistry.ObjectHolder("nebulaecraft:roadsign_88")
	public static final Block block = null;
	public BlockRoadsign88(ElementsNebulaecraftMod instance) {
		super(instance, 38);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("roadsign_88"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("nebulaecraft:roadsign_88", "inventory"));
	}
	public static final class BlockCustom extends Block {
		...
		public BlockCustom() {
			...
			setUnlocalizedName("roadsign_88");
			setHardness(1F);
			setResistance(10F);
			setLightLevel(0F);
			setLightOpacity(0);
