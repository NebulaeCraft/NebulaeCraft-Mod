...
public class BlockAsphaltStopLineConnected extends ElementsNebulaecraftMod.ModElement {
	...
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("asphalt_stop_line_connected"));
	...
	public void registerModels(ModelRegistryEvent event) {
        BlockAsphaltStopLineConnected.BlockCustom.EnumType[] allSubtypes = BlockAsphaltStopLineConnected.BlockCustom.EnumType.values();
        for (BlockAsphaltStopLineConnected.BlockCustom.EnumType subtype : allSubtypes) {
            ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), subtype.getMetadata(), new ModelResourceLocation("nebulaecraft:asphalt_stop_line_connected_" + subtype.getName(), "inventory"));
        }
    }
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setUnlocalizedName("asphalt_stop_line_connected");
        ...
        public enum EnumType implements IStringSerializable {
            ...
            private static final BlockAsphaltStopLineConnected.BlockCustom.EnumType[] META_LOOKUP = new BlockAsphaltStopLineConnected.BlockCustom.EnumType[values().length];

            static {
                for (BlockAsphaltStopLineConnected.BlockCustom.EnumType type : values()) {
            ...
            public static BlockAsphaltStopLineConnected.BlockCustom.EnumType byMetadata(int meta) {
