...
public class BlockClHalfShield extends ElementsNebulaecraftMod.ModElement {
    @GameRegistry.ObjectHolder("nebulaecraft:cl_half_shield")
    public static final Block block = null;

    public BlockClHalfShield(ElementsNebulaecraftMod instance) {
        super(instance, 112);
    }

    @Override
    public void initElements() {
        elements.blocks.add(() -> new BlockCustom().setRegistryName("cl_half_shield"));
    ...
    public void registerModels(ModelRegistryEvent event) {
        BlockClHalfShield.BlockCustom.EnumType[] allSubtypes = BlockClHalfShield.BlockCustom.EnumType.values();
        for (BlockClHalfShield.BlockCustom.EnumType subtype : allSubtypes) {
            ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), subtype.getMetadata(), new ModelResourceLocation("nebulaecraft:cl_half_shield_" + subtype.getName(), "inventory"));
        }
    }
    ...
    public static class BlockCustom extends Block {
        ...
        public BlockCustom() {
			...
			setUnlocalizedName("cl_half_shield");
			setHardness(1F);
			setResistance(10F);
			setLightLevel(0F);
			setLightOpacity(0);
        ...
        public enum EnumType implements IStringSerializable {
            ...
            private static final BlockClHalfShield.BlockCustom.EnumType[] META_LOOKUP = new BlockClHalfShield.BlockCustom.EnumType[values().length];

            static {
                for (BlockClHalfShield.BlockCustom.EnumType type : values()) {
            ...
            public static BlockClHalfShield.BlockCustom.EnumType byMetadata(int meta) {
