...
public class BlockTrafficlightPoleEnd extends ElementsNebulaecraftMod.ModElement {
    @GameRegistry.ObjectHolder("nebulaecraft:trafficlight_pole_end")
    public static final Block block = null;

    public BlockTrafficlightPoleEnd(ElementsNebulaecraftMod instance) {
        super(instance, 31);
    }
    ...
    public void registerModels(ModelRegistryEvent event) {
        BlockTrafficlightPoleEnd.BlockCustom.EnumType[] allSubtypes = BlockTrafficlightPoleEnd.BlockCustom.EnumType.values();
        for (BlockTrafficlightPoleEnd.BlockCustom.EnumType subtype : allSubtypes) {
            ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), subtype.getMetadata(), new ModelResourceLocation("nebulaecraft:trafficlight_pole_end_" + subtype.getName(), "inventory"));
        }
    }
    ...
    public static class BlockCustom extends Block {
        ...
        public BlockCustom() {
            super(Material.IRON);
            setUnlocalizedName("trafficlight_pole_end");
        ...
        public enum EnumType implements IStringSerializable {
            ...
            static {
                for (BlockTrafficlightPoleEnd.BlockCustom.EnumType type : values()) {
            ...
            public static BlockTrafficlightPoleEnd.BlockCustom.EnumType byMetadata(int meta) {
