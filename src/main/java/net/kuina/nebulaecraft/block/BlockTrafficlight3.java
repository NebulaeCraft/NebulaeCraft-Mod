...
public class BlockTrafficlight3 extends ElementsNebulaecraftMod.ModElement {
    @GameRegistry.ObjectHolder("nebulaecraft:trafficlight_3")
    ...
    public void initElements() {
        elements.blocks.add(() -> new BlockCustom().setRegistryName("trafficlight_3"));
    ...
    public void registerModels(ModelRegistryEvent event) {
        BlockTrafficlight3.BlockCustom.EnumType[] allSubtypes = BlockTrafficlight3.BlockCustom.EnumType.values();
        for (BlockTrafficlight3.BlockCustom.EnumType subtype : allSubtypes) {
            ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), subtype.getMetadata(), new ModelResourceLocation("nebulaecraft:trafficlight_3_" + subtype.getName(), "inventory"));
        }
    }
    ...
    public static class BlockCustom extends Block {
        ...
        public BlockCustom() {
            super(Material.IRON);
            setUnlocalizedName("trafficlight_3");
        ...
        public enum EnumType implements IStringSerializable {
            ...
            private static final BlockTrafficlight3.BlockCustom.EnumType[] META_LOOKUP = new BlockTrafficlight3.BlockCustom.EnumType[values().length];

            static {
                for (BlockTrafficlight3.BlockCustom.EnumType type : values()) {
            ...
            public static BlockTrafficlight3.BlockCustom.EnumType byMetadata(int meta) {
