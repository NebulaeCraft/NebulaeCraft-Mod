...
public class BlockTrafficlight4 extends ElementsNebulaecraftMod.ModElement {
    @GameRegistry.ObjectHolder("nebulaecraft:trafficlight_4")
    public static final Block block = null;

    public BlockTrafficlight4(ElementsNebulaecraftMod instance) {
        super(instance, 32);
    }

    @Override
    public void initElements() {
        elements.blocks.add(() -> new BlockCustom().setRegistryName("trafficlight_4"));
    ...
    public void registerModels(ModelRegistryEvent event) {
        BlockTrafficlight4.BlockCustom.EnumType[] allSubtypes = BlockTrafficlight4.BlockCustom.EnumType.values();
        for (BlockTrafficlight4.BlockCustom.EnumType subtype : allSubtypes) {
            ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), subtype.getMetadata(), new ModelResourceLocation("nebulaecraft:trafficlight_4_" + subtype.getName(), "inventory"));
        }
    }
    ...
    public static class BlockCustom extends Block {
        ...
        public BlockCustom() {
            super(Material.IRON);
            setUnlocalizedName("trafficlight_4");
        ...
        public enum EnumType implements IStringSerializable {
            ...
            private static final BlockTrafficlight4.BlockCustom.EnumType[] META_LOOKUP = new BlockTrafficlight4.BlockCustom.EnumType[values().length];

            static {
                for (BlockTrafficlight4.BlockCustom.EnumType type : values()) {
            ...
            public static BlockTrafficlight4.BlockCustom.EnumType byMetadata(int meta) {
