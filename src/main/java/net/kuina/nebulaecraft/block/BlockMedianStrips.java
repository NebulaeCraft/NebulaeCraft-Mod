...
public class BlockMedianStrips extends ElementsNebulaecraftMod.ModElement {
	@GameRegistry.ObjectHolder("nebulaecraft:median_strips")
	public static final Block block = null;
	public BlockMedianStrips(ElementsNebulaecraftMod instance) {
		super(instance, 4);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("median_strips"));
	...
	public void registerModels(ModelRegistryEvent event) {
        BlockMedianStrips.BlockCustom.EnumType[] allSubtypes = BlockMedianStrips.BlockCustom.EnumType.values();
        for (BlockMedianStrips.BlockCustom.EnumType subtype : allSubtypes) {
            ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), subtype.getMetadata(), new ModelResourceLocation("nebulaecraft:median_strips_" + subtype.getName(), "inventory"));
        }
    }
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setUnlocalizedName("median_strips");
        ...
        public AxisAlignedBB getBoundingBox(IBlockState state, IBlockAccess source, BlockPos pos) {
            if(state.getValue(SUBTYPE).getMetadata()==0){
                switch (state.getValue(BlockHorizontal.FACING)) {
                    ...
                    case NORTH :
                    default :
                        return new AxisAlignedBB(0.125, 0, 0, 0.875, 1, 1);
                    case EAST :
                    case WEST :
                        return new AxisAlignedBB(0, 0, 0.125, 1, 1, 0.875);
                ...
                switch (state.getValue(BlockHorizontal.FACING)) {
                    ...
                    case NORTH :
                    default :
                        return new AxisAlignedBB(0.125, -0.5, 0, 0.875, 0.5, 1);
                    case EAST :
                    case WEST :
                        return new AxisAlignedBB(0, -0.5, 0.125, 1, 0.5, 0.875);
        ...
        public enum EnumType implements IStringSerializable {
            ...
            private static final BlockMedianStrips.BlockCustom.EnumType[] META_LOOKUP = new BlockMedianStrips.BlockCustom.EnumType[values().length];

            static {
                for (BlockMedianStrips.BlockCustom.EnumType type : values()) {
            ...
            public static BlockMedianStrips.BlockCustom.EnumType byMetadata(int meta) {
